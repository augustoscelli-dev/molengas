...
export const PARTS = [
  ...
  { name: 'upperArmL', shape: 'capsule', hh: 0.10, r: 0.06,  off: [-0.24, 1.28, 0],  mass: 1 },
  { name: 'upperArmR', shape: 'capsule', hh: 0.10, r: 0.06,  off: [0.24, 1.28, 0],   mass: 1 },
  { name: 'forearmL',  shape: 'capsule', hh: 0.10, r: 0.055, off: [-0.24, 1.02, 0],  mass: 1 },
  { name: 'forearmR',  shape: 'capsule', hh: 0.10, r: 0.055, off: [0.24, 1.02, 0],   mass: 1 },
...
const JOINTS = [
  ...
  ['torso',  'upperArmL', [-0.24, 0.12, 0],  [0, 0.12, 0]],
  ['torso',  'upperArmR', [0.24, 0.12, 0],   [0, 0.12, 0]],

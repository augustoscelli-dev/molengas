...
export const MAPS = {
  p1: { up: 'KeyW', down: 'KeyS', left: 'KeyA', right: 'KeyD', punch: 'KeyF', grab: 'KeyG', jump: 'Space' },
  p2: { up: 'ArrowUp', down: 'ArrowDown', left: 'ArrowLeft', right: 'ArrowRight', punch: 'KeyK', grab: 'KeyL', jump: 'Enter' },
};
